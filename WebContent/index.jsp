                    ...
                    <div class="card">
                        ...
                        <div id="collapseA" class="collapse show" role="tabpanel" aria-labelledby="filter-heading">
                            <div class="card-block">
                                ...
                                <div class="row" id="filter-containter" onchange="filterMarkers()">
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCy49rkyTewVvRXpND7VhtXaOojb7PKG4w&callback=initialize&libraries=geometry,places" 
	async defer></script>
